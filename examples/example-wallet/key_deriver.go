...
type keyDeriverInterface interface {
	DerivePrivateKey(protocol wallet.Protocol, keyID string, counterparty wallet.Counterparty) (*ec.PrivateKey, error)
	DerivePublicKey(protocol wallet.Protocol, keyID string, counterparty wallet.Counterparty, forSelf bool) (*ec.PublicKey, error)
	DeriveSymmetricKey(protocol wallet.Protocol, keyID string, counterparty wallet.Counterparty) (*ec.SymmetricKey, error)
	RevealSpecificSecret(counterparty wallet.Counterparty, protocol wallet.Protocol, keyID string) ([]byte, error)
}
...
func (kd *KeyDeriver) DeriveSymmetricKey(protocol wallet.Protocol, keyID string, counterparty wallet.Counterparty) (*ec.SymmetricKey, error) {
	// If counterparty is 'anyone', use a fixed public key
	if counterparty.Type == wallet.CounterpartyTypeAnyone {
...
func (kd *KeyDeriver) DerivePublicKey(protocol wallet.Protocol, keyID string, counterparty wallet.Counterparty, forSelf bool) (*ec.PublicKey, error) {
...
func (kd *KeyDeriver) DerivePrivateKey(protocol wallet.Protocol, keyID string, counterparty wallet.Counterparty) (*ec.PrivateKey, error) {
	counterpartyKey, err := kd.normalizeCounterparty(counterparty)
	if err != nil {
		return nil, err
	}
...
func (kd *KeyDeriver) normalizeCounterparty(counterparty wallet.Counterparty) (*ec.PublicKey, error) {
...
func (kd *KeyDeriver) RevealSpecificSecret(counterparty wallet.Counterparty, protocol wallet.Protocol, keyID string) ([]byte, error) {
	counterpartyKey, err := kd.normalizeCounterparty(counterparty)
	if err != nil {
...
func (kd *KeyDeriver) RevealCounterpartySecret(counterparty wallet.Counterparty) (*ec.PublicKey, error) {
	if counterparty.Type == wallet.CounterpartyTypeSelf {
...
func (kd *KeyDeriver) computeInvoiceNumber(protocol wallet.Protocol, keyID string) (string, error) {
